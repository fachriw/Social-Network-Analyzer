...
import com.socialNetworkAnalyzer.twitter.AuthenticationException;
import com.socialNetworkAnalyzer.twitter.TwitterAuthentication;
import com.socialNetworkAnalyzer.twitter.TwitterInformation;
import twitter4j.*;
...
public class ModelTwitter {
    ...
    public void packStatusIndices(TwitterInformation ti, TwitterInformation.sourceType st, ArrayList<Status> statuses) {
        ...
        ti.setIndices(st, TwitterInformation.orderType.FAVORITED, getStatusIndicesByTimeFrame(statusesArray, statusIndicesByFavorited));
        ti.setIndices(st, TwitterInformation.orderType.RETWEETED, getStatusIndicesByTimeFrame(statusesArray, statusIndicesByRetweeted));
    }
    ...
    public TwitterInformation getTwitterInfo(boolean isSelf) throws TwitterException {
        ...
        packStatusIndices(t, TwitterInformation.sourceType.USERTIMELINE, ustatuses);

        ArrayList<Status> mstatuses = API_REQUEST_getMentionsTweets(isSelf);

        packStatusIndices(t, TwitterInformation.sourceType.MENTIONSTIMELINE, mstatuses);
